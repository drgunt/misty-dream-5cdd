...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/misty-dream-5cdd)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/misty-dream-5cdd
```

A live public deployment of this template is available at [https://misty-dream-5cdd.templates.workers.dev](https://misty-dream-5cdd.templates.workers.dev)
